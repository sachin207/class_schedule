...
if (isset($_POST['submit'])) {
  ...
  if(empty($courseid)){
      ...
      $query = "SELECT * FROM section WHERE course_id = '$courseid' AND semester = '$semester' AND year ='$year' ";
      $data = mysqli_query($dbc, $query) ;
      if (mysqli_num_rows($data) > 0) {
 ...
 if(empty($form_errors['courseid']) && empty($form_errors['year']) && empty($form_errors['student'])){
  $query = "INSERT INTO section
                (course_id, semester, year, user_id, student)
                VALUES
                ('$courseid', '$semester', '$year', '$user_id', '$student')";
      $result = mysqli_query($dbc, $query);
      $section_id = mysqli_insert_id($dbc);
 }
  ...
  if(isset($_POST['timeslot1'])){ 
    ...
    if($sem==1)
    {
      $query = "SELECT * FROM timeslot,section WHERE section.id =timeslot.section_id AND year='$year' AND (semester='$semester' OR semester='Spring') AND day='$day1' AND room_no='$room1' AND (start_time<'$end1' AND end_time>'$start1')";
      $data = mysqli_query($dbc, $query) ;
      if (mysqli_num_rows($data) > 0) {
    ...
    {
      $query = "SELECT * FROM timeslot,section WHERE section.id =timeslot.section_id AND year='$year' AND (semester='$semester' OR semester='Fall') AND day='$day1' AND room_no='$room1' AND (start_time<'$end1' AND end_time>'$start1')";
      $data = mysqli_query($dbc, $query) ;
      if (mysqli_num_rows($data) > 0) {
        $form_errors['timeslot1'] = '<ul style="margin-left:130px"><li>Time Slot 1 conflit with other courses.</li></ul>';
      }
    ...
    {
      $query = "SELECT * FROM timeslot,section WHERE section.id =timeslot.section_id AND year='$year' AND (semester='$semester' OR semester='Spring-1' OR semester='Spring-2' OR semester ='Spring-3') AND day='$day1' AND room_no='$room1' AND (start_time<'$end1' AND end_time>'$start1')";
      $data = mysqli_query($dbc, $query) ;
      if (mysqli_num_rows($data) > 0) {
        $form_errors['timeslot1'] = '<ul style="margin-left:130px"><li>Time Slot 1 conflit with other courses.</li></ul>';
      }
    ...
    {
      $query = "SELECT * FROM timeslot,section WHERE section.id =timeslot.section_id AND year='$year' AND (semester='$semester' OR semester='Fall-1' OR semester='Fall-2' OR semester ='Fall-3') AND day='$day1' AND room_no='$room1' AND (start_time<'$end1' AND end_time>'$start1')";
      $data = mysqli_query($dbc, $query) ;
      if (mysqli_num_rows($data) > 0) {
        $form_errors['timeslot1'] = '<ul style="margin-left:130px"><li>Time Slot 1 conflit with other courses.</li></ul>';
      }
  ...
  if(isset($_POST['timeslot2'])){
    ...
    if($sem==1){
    $query = "SELECT * FROM timeslot,section WHERE section.id =timeslot.section_id AND year='$year' AND (semester='$semester' OR semester='Spring') AND day='$day2' AND room_no='$room2' AND (start_time<'$end2' AND end_time>'$start2')";
    $data = mysqli_query($dbc, $query) ;
      if (mysqli_num_rows($data) > 0) {
    ...
    $query = "SELECT * FROM timeslot,section WHERE section.id =timeslot.section_id AND year='$year' AND (semester='$semester' OR semester='Fall') AND day='$day2' AND room_no='$room2' AND (start_time<'$end2' AND end_time>'$start2')";
    $data = mysqli_query($dbc, $query) ;
      if (mysqli_num_rows($data) > 0) {
        $form_errors['timeslot2'] = '<ul style="margin-left:130px"><li>Time Slot 2 conflit with other courses.</li></ul>';
      }
    ...
    $query = "SELECT * FROM timeslot,section WHERE section.id =timeslot.section_id AND year='$year' AND (semester='$semester' OR semester='Spring-1' OR semester='Spring-2' OR semester ='Spring-3') AND day='$day2' AND room_no='$room2' AND (start_time<'$end2' AND end_time>'$start2')";
    $data = mysqli_query($dbc, $query) ;
      if (mysqli_num_rows($data) > 0) {
        $form_errors['timeslot2'] = '<ul style="margin-left:130px"><li>Time Slot 2 conflit with other courses.</li></ul>';
      }
    ...
    $query = "SELECT * FROM timeslot,section WHERE section.id =timeslot.section_id AND year='$year' AND (semester='$semester' OR semester='Fall-1' OR semester='Fall-2' OR semester ='Fall-3') AND day='$day2' AND room_no='$room2' AND (start_time<'$end2' AND end_time>'$start2')";
    $data = mysqli_query($dbc, $query) ;
      if (mysqli_num_rows($data) > 0) {
        $form_errors['timeslot2'] = '<ul style="margin-left:130px"><li>Time Slot 2 conflit with other courses.</li></ul>';
      }
...
if(($start3 > $end3))
    ...
    if($sem==1){
    $query = "SELECT * FROM timeslot,section WHERE section.id =timeslot.section_id AND year='$year' AND (semester='$semester' OR semester='Spring') AND day ='$day3' room_no='$room3' AND (start_time<'$end3' AND end_time>'$start3')";
    $data = mysqli_query($dbc, $query) ;
      if (mysqli_num_rows($data) > 0) {
    ...
    $query = "SELECT * FROM timeslot,section WHERE section.id =timeslot.section_id AND year='$year' AND (semester='$semester' OR semester='Fall') AND day ='$day3' room_no='$room3' AND (start_time<'$end3' AND end_time>'$start3')";
    $data = mysqli_query($dbc, $query) ;
      if (mysqli_num_rows($data) > 0) {
        $form_errors['timeslot3'] = '<ul style="margin-left:130px"><li>Time Slot 3 conflit with other courses.</li></ul>';
      }
    ...
    $query = "SELECT * FROM timeslot,section WHERE section.id =timeslot.section_id AND year='$year' AND (semester='$semester' OR semester='Spring-1' OR semester='Spring-2' OR semester='Spring-3') AND day ='$day3' room_no='$room3' AND (start_time<'$end3' AND end_time>'$start3')";
    $data = mysqli_query($dbc, $query) ;
      if (mysqli_num_rows($data) > 0) {
        $form_errors['timeslot3'] = '<ul style="margin-left:130px"><li>Time Slot 3 conflit with other courses.</li></ul>';
      }
    ...
    $query = "SELECT * FROM timeslot,section WHERE section.id =timeslot.section_id AND year='$year' AND (semester='$semester' OR semester='Fall-1' OR semester='Fall-2' OR semester='Fall-3') AND day ='$day3' room_no='$room3' AND (start_time<'$end3' AND end_time>'$start3')";
    $data = mysqli_query($dbc, $query) ;
      if (mysqli_num_rows($data) > 0) {
        $form_errors['timeslot3'] = '<ul style="margin-left:130px"><li>Time Slot 3 conflit with other courses.</li></ul>';
      }
    ...
    if (empty($form_errors)) {
      ...
      redirect('section_success.php');
    }
    else{
      $query1 = "DELETE FROM section WHERE id = '$section_id'";
    ...
    <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1">
        <div class="panel panel-default">
            <div class="panel-heading">
                <strong> <center>  Add Course to Offer </center> </strong>  
            </div>
            <div class="panel-body" id="panal_body">
...
<strong style="color:red;margin-left:130px;"><br><?php 
  ...
  ?></strong>
    ...
    <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">Student En-rolled</label>
    <div class="col-sm-6">
      <input type="text" class="form-control" id="student" name="student" placeholder="Student En-rolled" value="<?php if (!empty($student)) echo $student; ?>">
    </div>
    </div>
    <strong style="color:red;margin-left:130px;"><br><?php 
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
    	<input type="submit" value="Add Section" id="submit" name="submit" class="btn btn-success "/>                 
    </div>
  </div>
</form>
            </div>
